...
function showGeneralHelp(): void {
  ...
  console.log(formatBoxLine(formatSecondary('Type-safe, cross-platform RPC framework')));
  console.log(formatBoxLine(''));
  ...
  console.log(formatBoxLine(formatSecondary('  Generate type-safe clients and servers from API contracts')));
  console.log(formatBoxLine(formatSecondary('  Usage: xrpc generate [options]')));
  console.log(formatBoxLine(formatSecondary('  Options: -i/--input, -o/--output, -t/--targets')));
  console.log(formatBoxLine(''));

  console.log(formatBoxLine(formatCommand('validate')));
  console.log(formatBoxLine(formatSecondary('  Validate API contract for type safety and structure')));
  console.log(formatBoxLine(formatSecondary('  Usage: xrpc validate [file]')));
  console.log(formatBoxLine(''));

  console.log(formatBoxLine(formatCommand('init')));
  console.log(formatBoxLine(formatSecondary('  Initialize xRPC in your project with interactive setup')));
  console.log(formatBoxLine(formatSecondary('  Usage: xrpc init')));
  console.log(formatBoxLine(''));

  console.log(formatBoxLine(formatCommand('help')));
  console.log(formatBoxLine(formatSecondary('  Show this help message or help for a specific command')));
  ...
  for (let i = 0; i < targets.length; i++) {
    ...
    console.log(formatBoxLine(formatTreeItem(formatTarget(targets[i]), isLast)));
  }
  console.log(formatBoxLine(''));
  console.log(formatBoxFooter());
  console.log();
  ...
  console.log(formatBoxLine(formatCode('xrpc generate -i src/api.ts -o generated -t go-server')));
  console.log(formatBoxLine(''));
  console.log(formatBoxLine(formatSecondary('# Generate code for multiple targets')));
  console.log(formatBoxLine(formatCode('xrpc generate -i src/api.ts -o generated -t go-server,react-client')));
  console.log(formatBoxLine(''));
...
function showGenerateHelp(): void {
  ...
  console.log(formatBoxLine(''));
  console.log(formatBoxLine(formatSecondary('Generate type-safe clients and servers from API contracts defined with Zod schemas.')));
  console.log(formatBoxLine(''));
  console.log(formatBoxFooter());
  console.log();
  ...
  console.log(formatBoxLine(formatSecondary('  Path to API contract file (e.g., src/api.ts)')));
  console.log(formatBoxLine(''));
  console.log(formatBoxLine(formatCommand('-o, --output <directory>')));
  console.log(formatBoxLine(formatSecondary('  Output directory for generated code (default: generated)')));
  console.log(formatBoxLine(''));
  console.log(formatBoxLine(formatCommand('-t, --targets <targets>')));
  console.log(formatBoxLine(formatSecondary('  Comma-separated list of targets to generate')));
  const targets = listTargets();
  for (let i = 0; i < targets.length; i++) {
    const isLast = i === targets.length - 1;
    console.log(formatBoxLine(formatSecondary('  ') + formatTreeItem(formatTarget(targets[i]), isLast)));
  }
  console.log(formatBoxLine(''));
  console.log(formatBoxFooter());
  console.log();
  ...
  console.log(formatBoxLine(formatCode('xrpc generate -i src/api.ts -o generated -t go-server')));
  console.log(formatBoxLine(''));
  console.log(formatBoxLine(formatSecondary('# Generate for multiple targets')));
  console.log(formatBoxLine(formatCode('xrpc generate -i api.ts -o out -t go-server,react-client')));
  console.log(formatBoxLine(''));
  console.log(formatBoxLine(formatSecondary('# Interactive mode (prompts for missing arguments)')));
  console.log(formatBoxLine(formatCode('xrpc generate')));
  console.log(formatBoxLine(''));
  console.log(formatBoxFooter());
  console.log();
  ...
  console.log(formatSecondary('  3. Generate type-safe code for selected targets'));
...
function showValidateHelp(): void {
  ...
  console.log(formatBoxLine(''));
  console.log(formatBoxLine(formatSecondary('Validate an API contract file for type safety, syntax, and structure.')));
  console.log(formatBoxLine(''));
  console.log(formatBoxFooter());
  console.log();
  ...
  console.log(formatBoxLine(formatSecondary('  Path to API contract file (e.g., src/api.ts)')));
  console.log(formatBoxLine(formatSecondary('  Can also be provided as a positional argument')));
  console.log(formatBoxLine(''));
  console.log(formatBoxFooter());
  console.log();
  ...
  console.log(formatBoxLine(formatTreeItem('Contract structure (router, endpoints)', false)));
  console.log(formatBoxLine(formatTreeItem('Endpoint definitions (query/mutation types)', false)));
  console.log(formatBoxLine(formatTreeItem('Schema validity (input/output schemas)', true)));
  console.log(formatBoxLine(''));
  console.log(formatBoxFooter());
  console.log();
  ...
  console.log(formatSecondary('Use it in CI/CD pipelines to ensure contract validity.'));
  console.log();
}
...
function showInitHelp(): void {
  ...
  console.log(formatBoxLine(''));
  console.log(formatBoxLine(formatSecondary('Initialize xRPC in your project with an interactive setup wizard.')));
  console.log(formatBoxLine(''));
  console.log(formatBoxFooter());
  console.log();
  ...
  console.log(formatBoxLine(''));
  console.log(formatBoxLine(formatCommand('1. Detects your project structure')));
  console.log(formatBoxLine(formatSecondary('   Identifies monorepo type, scans for apps, finds existing contracts')));
  console.log(formatBoxLine(''));
  console.log(formatBoxLine(formatCommand('2. Guides you through setup')));
  console.log(formatBoxLine(formatSecondary('   Choose contract, select targets, configure output directories')));
  console.log(formatBoxLine(''));
  console.log(formatBoxLine(formatCommand('3. Creates configuration files')));
  console.log(formatBoxLine(formatSecondary('   xrpc.toml, sample contract, API package (for monorepos)')));
  console.log(formatBoxLine(''));
  console.log(formatBoxFooter());
  console.log();
  ...
  console.log(formatBoxLine(''));
  console.log(formatBoxLine(formatTreeItem('Next.js, React, Vite → react-client', false)));
  console.log(formatBoxLine(formatTreeItem('Go → go-server', false)));
  console.log(formatBoxLine(formatTreeItem('Python, Node.js (detected, no target yet)', true)));
  console.log(formatBoxLine(''));
  console.log(formatBoxFooter());
  console.log();

  console.log(formatInfo('After running init, use "xrpc generate" to generate code.'));
  console.log();
}
